		...
		if (currentPatchset == null) {
			...
			DataView<RevCommit> commitsView = new DataView<RevCommit>("commit", commitsDp) {
				...
				public void populateItem(final Item<RevCommit> item) {
					...
					item.add(new LinkPanel("unifieddiff", "link", getString("gb.unifieddiff"), CommitDiffPage.class,
						WicketUtils.newObjectParameter(repositoryName, commit.getName(), 1), true));
					/*
